...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.ghkim.aviary_ios.js')
	...
	f = os.path.join(cwd,'Classes','ComGhkimAviary_iosModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.ghkim.aviary_ios.js']
